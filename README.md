...
Yеt-Another-Validation - мой собственный пример декларативной валидации в функциональном стиле на Typescript. Зачем нужна ещё одна библиотека валидации, когда есть масса прекрасных библиотек типа yup, joi и т.д.? Yеt-Another-Validation задумывалась не как библиотека или npm-пакет, а как копируемая и контролируемая директория в доменный слой проектов, воплощающих идеи Чистой Архитектуры и Domain Driven Design. Проектов, где использование внешних библиотек в доменном слое недопустимо, а необходимость валидации именно там присутствует. Вдохновлен собственным опытом и https://bespoyasov.ru/blog/declarative-rule-based-validation/  
