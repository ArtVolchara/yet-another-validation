...
// because isPositiveNumber has the input parameter of number type, it is made as second item in validator chain
// where the first item is the validator that checks if the value is a number.
describe('isPositiveNumber validator test', () => {
